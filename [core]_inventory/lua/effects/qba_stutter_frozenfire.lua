...
for i = 1, 30 do
	...
	local ptcl = PE:Add( 'effects/timefreeze_triangle', spawnPos )
		...
		ptcl:SetColor( math.random(150,255),math.random(150,255), math.random(50,155))
...
render.DrawQuadEasy( self:GetPos() + Vector( 0, 0, 5 ), Vector( 0, 0, 1 ), size, size, Color( 255, 255, 155 ), 0 )
